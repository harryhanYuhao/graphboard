...
There is a git submodule in the directory `./doc/zxw-graphboard-doc`. 
When updating the documentation, record the git commit hash of the main
repo the documentation has been updated to.
